...
[GET IN TOUCH](coming-soon.qmd){.cta-primary}
...
![Professional BIM Technology - Advanced 3D modeling and cost estimation](images/bim-technology.png){style="max-width: 900px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
...
![Data-Driven Construction Analytics - Real-time cost estimation and project insights](images/data-analysis.png){style="max-width: 1000px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
...
::: {.image-section style="margin: 64px 0; text-align: center;"}
![Advanced BIM Workflows - Collaborative project management and estimation](images/bim-workflow.png){style="max-width: 1000px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
...
[Schedule Your Pilot Project →](coming-soon.qmd){.cta-primary}
:::
...
[Get Started →](coming-soon.qmd){.cta-primary}
:::
:::
