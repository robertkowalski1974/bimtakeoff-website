...
![BIM model with quantity takeoff overlay](images/bim-technology.png){width=900 style="max-width: 900px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
...
![Cost analysis dashboard for a construction tender](images/data-analysis.png){style="max-width: 1000px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
...
::: {.image-section style="margin: 64px 0; text-align: center;"}
![BIM 5D workflow from model to bill of quantities](images/bim-workflow.png){style="max-width: 1000px; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: block; margin-left: auto; margin-right: auto;"}
:::
