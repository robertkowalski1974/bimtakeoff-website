...
function generatePDFReport() {
  ...
  if (isPolish) {
    ...
    doc.addPage();
    generateExecutiveSummaryPL(doc, { orange, green, gray, darkGray, lightGray, projectValue, totalSavings, roiPercentage, currency, timeline, projectType });
    ...
    // ===== PAGE 2: EXECUTIVE SUMMARY =====
    doc.addPage();
    generateExecutiveSummary(doc, { orange, green, gray, darkGray, lightGray, projectValue, totalSavings, roiPercentage, currency, timeline, projectType });
...
function generateExecutiveSummary(doc, { orange, green, gray, darkGray, lightGray, projectValue, totalSavings, roiPercentage, currency, timeline, projectType }) {
  // Page header
  doc.setFillColor(...orange);
...
function generateExecutiveSummaryPL(doc, { orange, green, gray, darkGray, lightGray, projectValue, totalSavings, roiPercentage, currency, timeline, projectType }) {
  // Page header
  doc.setFillColor(...orange);
  doc.rect(0, 0, 210, 20, 'F');
  doc.setTextColor(255, 255, 255);
