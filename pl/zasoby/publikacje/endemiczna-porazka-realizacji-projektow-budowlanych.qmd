---
title: "Endemiczna porażka realizacji projektów budowlanych: dlaczego 91,5% projektów kończy się niepowodzeniem"
description: "Analiza przyczyn niepowodzeń projektów budowlanych. Dane Oksfordu: 91,5% projektów przekracza budżet lub harmonogram, ze średnim przekroczeniem 62%."
page-layout: full
date: "2025-11-29"
...
### <i class="bi bi-emoji-smile" style="color: var(--bim-orange);" aria-hidden="true"></i> Optymistyczne nastawienie
...
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-bar-chart" style="color: var(--bim-orange);" aria-hidden="true"></i> Strategiczne zniekształcanie
...
### <i class="bi bi-search" style="color: var(--bim-orange);" aria-hidden="true"></i> Niskie inwestycje w B+R
...
::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-laptop" style="color: var(--bim-orange);" aria-hidden="true"></i> Cyfrowe opóźnienie

Indeks cyfryzacji McKinsey plasuje budownictwo na przedostatnim miejscu w USA i ostatnim w Europie.
:::

::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-people" style="color: var(--bim-orange);" aria-hidden="true"></i> Niedobór pracowników
...
::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-arrow-repeat" style="color: var(--bim-orange);" aria-hidden="true"></i> Epidemia przeróbek
...
<p style="color: var(--bim-white); font-size: 16px; margin: 8px 0;"><i class="bi bi-patch-check-fill" style="color: var(--bim-orange);" aria-hidden="true"></i> <strong>Kosztorysowanie BIM 5D</strong></p>
