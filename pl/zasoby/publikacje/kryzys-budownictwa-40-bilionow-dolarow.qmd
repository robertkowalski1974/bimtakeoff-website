...
### <i class="bi bi-exclamation-triangle" style="color: var(--bim-orange);" aria-hidden="true"></i> Wyniki megaprojektów
...
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-graph-down" style="color: var(--bim-orange);" aria-hidden="true"></i> Erozja marż
