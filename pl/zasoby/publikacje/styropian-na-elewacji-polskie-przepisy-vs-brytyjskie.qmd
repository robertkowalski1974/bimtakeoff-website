...
image: "../../../images/EPS-polskie-warunki.jpg"
lang: pl
---
...
### <i class="bi bi-shield-check" style="color: var(--bim-orange);" aria-hidden="true"></i> Zalecenia SITP WP-03:2018
...
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-exclamation-triangle" style="color: var(--bim-orange);" aria-hidden="true"></i> Stanowisko PSPS
...
::: {style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin: 32px 0;"}
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-file-earmark-text" style="color: var(--bim-orange);" aria-hidden="true"></i> Rozporządzenie CPR (EU) 2024/3110
...
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-building" style="color: var(--bim-orange);" aria-hidden="true"></i> Dyrektywa EPBD (2024/1275)
