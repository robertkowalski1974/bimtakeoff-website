...
<div style="flex: 1;"><strong>Wcześniejsze projekty</strong> — Najlepszym wyznacznikiem przyszłego sukcesu jest sprawna realizacja popzedniego projektu. Badania stwierdzają: „Najlepszym sprzedawcą, są pracownicy którzy bezproblemowo zrealizowali poprzedni projekt."</div>
</div>
...
<div style="flex: 1;"><strong>Proponowana metodologia</strong> — Warta 20-30% oceny. Jasne przedstawienie koncepcji realizacji projektu dramatycznie zwiększają szanse na wygraną.</div>
</div>
