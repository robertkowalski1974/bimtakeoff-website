...
<i class="bi bi-tools" style="font-size: 120px; color: #FF9900; margin-bottom: 32px; display: block;" aria-hidden="true"></i>
...
[<i class="bi bi-house-door" aria-hidden="true"></i> Powrót do Strony Głównej](index.qmd){.cta-primary style="font-size: 18px; padding: 16px 48px;"}
:::
