---
title: "The Endemic Failure of Construction Project Delivery: Why 91.5% of Projects Fail"
description: "Why construction projects consistently fail. Oxford University data shows 91.5% exceed budget or schedule, with mean cost overruns of 62%."
page-layout: full
date: "2025-11-29"
author: "Robert Kowalski"
categories: [Project Management, Cost Overruns, Construction Industry, Megaprojects, Research Analysis]
image: "../../images/construction-failure-cover.jpg"
---
...
### <i class="bi bi-emoji-smile" style="color: var(--bim-orange);" aria-hidden="true"></i> Optimism Bias
...
::: {style="padding: 24px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-bar-chart" style="color: var(--bim-orange);" aria-hidden="true"></i> Strategic Misrepresentation
...
### <i class="bi bi-search" style="color: var(--bim-orange);" aria-hidden="true"></i> Low R&D Investment
...
::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-laptop" style="color: var(--bim-orange);" aria-hidden="true"></i> Digital Lag

McKinsey's digitisation index ranks construction second-to-last in the US and last in Europe.
:::

::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-people" style="color: var(--bim-orange);" aria-hidden="true"></i> Workforce Shortage

The US construction industry needs approximately **439,000 new workers in 2025** simply to balance supply and demand.
:::

::: {style="padding: 20px; background: var(--bim-light-gray); border-radius: 8px; border-left: 4px solid var(--bim-orange);"}
### <i class="bi bi-arrow-repeat" style="color: var(--bim-orange);" aria-hidden="true"></i> Rework Epidemic
