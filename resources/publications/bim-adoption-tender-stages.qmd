...
description: "Analysis of BIM adoption barriers at tender stage, comparing UK success (73%) with Poland's 8.9% contractor adoption. Policy recommendations for 2030."
page-layout: full
date: "2025-10-05"
author: "Robert Kowalski"
categories: [BIM, Construction Technology, Poland, UK, Tender Management]
image: "../../images/bim-adoption-cover.jpg"
---
...
<p style="color: var(--bim-white); font-size: 16px; margin: 8px 0;"><i class="bi bi-patch-check-fill" style="color: var(--bim-orange);" aria-hidden="true"></i> <strong>ISO 19650 Certified Processes</strong></p>
<p style="color: var(--bim-white); font-size: 16px; margin: 8px 0;"><i class="bi bi-patch-check-fill" style="color: var(--bim-orange);" aria-hidden="true"></i> <strong>UK & Polish Market Expertise</strong></p>
<p style="color: var(--bim-white); font-size: 16px; margin: 8px 0;"><i class="bi bi-patch-check-fill" style="color: var(--bim-orange);" aria-hidden="true"></i> <strong>Takeoffs and priced bills from 2D drawings and models</strong></p>
:::
:::
:::
